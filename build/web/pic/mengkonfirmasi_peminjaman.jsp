            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <button type="button" class="btn btn-primary" onclick="$('#tanggapi<%= i%>').modal('show')">
                                                                    Tanggapi
                                                                </button>

                                                                <!-- Modal -->
                                                                <div class="modal fade" id="tanggapi<%= i%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body text-start">
                                                                                <ul class="list-unstyled mb-0">
                                                                                    <li>
                                                                                        <p class="mb-2">
                                                                                            <span class="fw-bold me-2">Tanggapi peminjaman:</span>
                                                                                            Lab <%= peminjaman[i].getNo_lab() %>
                                                                                        </p>
                                                                                        <p class="mb-2">
                                                                                            <span class="fw-bold me-2">Dengan keterangan:</span>
                                                                                            <%= peminjaman[i].getKeterangan()%>
                                                                                        </p>
                                                                                        <p class="mb-2">
                                                                                            <span class="fw-bold me-2">Yang dipinjam oleh:</span>
                                                                                            <%= peminjaman[i].getKetua_kegiatan() %>
                                                                                        </p>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <a href="proses_konfirmasi.jsp?id=<%= peminjaman[i].getId_peminjaman()%>&aksi=disetujui" class="btn btn-primary">Setujui</a>
                                                                                <a href="proses_konfirmasi.jsp?id=<%= peminjaman[i].getId_peminjaman()%>&aksi=ditolak" class="btn btn-danger">Tolak</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <%
                            String pesan = "";
                            if (request.getAttribute("save_data") != null) {
                                if (request.getAttribute("save_data").equals("berhasil")) {
                                    pesan = "Peminjaman berhasil ditanggapi!";
                                } else if (request.getAttribute("save_data").equals("gagal")) {
                                    pesan = "Peminjaman gagal ditanggapi!";
                                }
                        %>

                        <!-- Proses Feedback -->
                        <div class="modal fade" tabindex="-1" role="dialog" id="notifikasi">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
